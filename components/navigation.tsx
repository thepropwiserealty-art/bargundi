...
export default function Navigation() {
  ...
  return (
    <>
      <nav
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 animate-in slide-in-from-top duration-500 ${
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-40 md:hidden animate-in fade-in duration-200">
          ...
          {/* Menu Content */}
          <div
            className="fixed top-16 left-0 right-0 bg-background border-b shadow-lg animate-in slide-in-from-top-10 duration-200"
          >
